...
GX_CONST GX_UBYTE display_1_HELLO_WORLD_English[] = "Hello World from Yes";
GX_CONST GX_UBYTE display_1_CHECKBOX_TEXT_English[] = "Press here pls";
GX_CONST GX_UBYTE display_1_BUTTON_DISABLED_English[] = "Stay here";
GX_CONST GX_UBYTE display_1_BUTTON_ENABLED_English[] = "Go there";
GX_CONST GX_UBYTE display_1_INSTRUCT_CHECKBOX_English[] = "Press something to stuff";
GX_CONST GX_UBYTE display_1_WINDOW1_English[] = "Window";
GX_CONST GX_UBYTE display_1_WINDOW2_English[] = "The other window";
GX_CONST GX_UBYTE display_1_INSTRUCT_BUTTON_English[] = "Pres here to something";
